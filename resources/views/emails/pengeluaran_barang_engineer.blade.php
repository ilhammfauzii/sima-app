...
<head>
    ...
    <title>Notifikasi Pengeluaran Barang Engineer{{ config('app.name') }}</title>
    <style>
        body { 
...
<body>
    <div class="container">
        <div class="header">
            ...
            <div class="sub-header">Notifikasi Pengeluaran Barang Engineer</div>
        </div>

        <div class="content">
            <div class="greeting">
                Kepada Yth. <strong>{{ $pic->nama }}</strong>,
            </div>

            <div class="highlight">
                Anda tercatat sebagai <strong>PIC/Admin</strong> untuk pengeluaran barang <strong>Engineer</strong> pada Sistem Inventaris Manajemen Aset.
            </div>

            <p>
                Berikut adalah ringkasan data pengeluaran barang Engineer yang telah disetujui:
            </p>
            ...
            <p style="margin-top: 20px;">
                Apabila terdapat ketidaksesuaian data atau kendala terkait pengeluaran barang Engineer ini, 
