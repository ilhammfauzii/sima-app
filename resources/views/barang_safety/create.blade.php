...
@section('title', 'Penambahan Alat dan Stok Alat Safety')

@section('content')
<div class="container-fluid">
    <h1 class="h3 mb-4 text-gray-800 font-weight-bold text-center text-md-left">TAMBAH ALAT DAN STOK ALAT SAFETY</h1>
    <form method="POST" action="{{ route('barang_safety.store') }}"> 
        @csrf
        <div class="card shadow mb-4">
            <div class="card-body">
                ...
                <div class="d-flex justify-content-end mt-3">
                    ...
                    <a href="{{ route('pengadaan_barang_safety.menu') }}" class="btn btn-secondary">Kembali</a>
                </div>
