        ...
        <div class="card-body">
            ...
            <form action="{{ route('customers.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea name="alamat_lengkap" id="alamat_lengkap" class="form-control" rows="3">{{ old('alamat_lengkap') }}</textarea>
                </div>

                <div class="form-group">
                    <label for="id_pln">ID PLN</label>
                    <input type="text" name="id_pln" id="id_pln" class="form-control" value="{{ old('id_pln') }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="referensi_reseller" id="referensi_reseller" class="form-control" value="{{ old('referensi_reseller') }}">
                </div>

                <div class="mt-4">
                    <button type="submit" class="btn btn-primary">Simpan</button>
                    <a href="{{ route('customers.menu') }}" class="btn btn-secondary">Kembali</a>
                </div>
            </form>
