...
<div class="container">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">TAMBAH PENGELUARAN ALAT ENGINEER</h1>
    </div>
    ...
    <div class="card bg-white shadow mb-4">
        <div class="card-body">
            ...
            <form action="{{ route('pengeluaran_barang_engineer.store') }}" method="POST" enctype="multipart/form-data" data-item-name="barang_engineer_id">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <textarea name="keterangan" id="keterangan" class="form-control" rows="3" placeholder="Contoh: Untuk instalasi perangkat di site A"></textarea>
                </div>
                ...
                <div id="items-container">
                    <div class="item-row row mb-2 align-items-end">
                        <div class="col-md-5">
                            ...
                            <select name="items[0][barang_engineer_id]" id="item-select-0" class="form-control select2-item" data-placeholder="-- Pilih Alat --" required>
                                <option value=""></option>
                ...
                <div class="mt-4">
                    ...
                    <a href="{{ route('pengeluaran_barang_engineer.menu') }}" class="btn btn-secondary">Kembali</a>
                </div>
            </form>
        </div>
    </div>
